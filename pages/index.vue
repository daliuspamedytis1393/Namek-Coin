    ...
    <div class="box">
        <div class="main-bg">
            <div class="bg-wrapper">
                <div class="dots-1 dots"></div>
                <div class="dots-2 dots"></div>
                <div class="dots-3 dots"></div>
            </div>
        </div>
        ...
        >
            ...
            >
                <div
                    class="time-box"
                    :class="{
                    'last-unit': index === timeUnits.length - 1,
                    }"
                >
                    <span class="time-value">{{ parseTimeLeft(timeLeft)[unit.name] }}</span>
